#############################################################################
# Makefile for building: bearddollars-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Feb 7 01:13:34 2016
# Project:  BeardDollars-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake USE_UPNP=- -o Makefile BeardDollars-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu /tmp/BeardDollars/src/leveldb/libleveldb.a /tmp/BeardDollars/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: BeardDollars-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile BeardDollars-qt.pro
...
/tmp/BeardDollars/src/leveldb/libleveldb.a: FORCE
	cd /tmp/BeardDollars/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/BeardDollars/build/build.h: FORCE
	cd /tmp/BeardDollars; /bin/sh share/genbuild.sh /tmp/BeardDollars/build/build.h
